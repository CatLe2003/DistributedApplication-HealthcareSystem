                            ...
                            <form method="POST" class="">
                                <div class="form-row">
                                    <div class="form-row__flex">
                                        <div class="form-col">
                                            <label for="" class="form-col__label">Record ID</label>
                                            <input type="text" name="record_id" class="form-control" value="123" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-row__flex">
                                        <div class="form-col">
                                            ...
                                            <input type="text" name="symptoms" class="form-control" value="abc">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-row__flex">
                                        <div class="form-col">
                                            ...
                                            <input type="text" name="diagnosis" class="form-control" value="23">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-row__flex">
                                        <div class="form-col">
                                            ...
                                            <input type="text" name="notes" class="form-control" value="Street 5">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-col margin-0">
                                        <div class="form-col-bottom">
                                            <input type="submit" name="updateMedRecord" value="Update Record" class="btn-control btn-control-add" value="">
                                        </div>
                                    </div>
                                </div>
                            </form>
