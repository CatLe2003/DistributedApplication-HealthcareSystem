...
<head>
    ...
    <link rel="stylesheet" href="/DistributedApplication-HealthcareSystem/Frontend/assets/css/style.css">
...
<body>
    <div class="container">
        ...
        <header class="nav-container">
            <div class="nav-left">
                <img src="/DistributedApplication-HealthcareSystem/Frontend/assets/images/smile-2_removebg.png" alt="Smile.png" class="nav-header__logo">
                <h1 class="nav-header__name">LifeCare</h1>
            </div>
            <div class="nav-items">
                <a class="nav-item" href="../layouts/patient.blade.php">Homepage</a>
                <a class="nav-item" href="list_departments.bladephp">Services</a>
            ...
            <div class="nav-right">
                ...
                <div class="user-dropdown">
                    ...
                    <div class="dropdown-user">
                        <a href="../medical_record/profile.blade.php">
                            <i class="fa-solid fa-file-invoice nav-item__icon"></i>
                            Profile
                        </a>

                        <a href="../medical_record/medical_records.blade.php">
